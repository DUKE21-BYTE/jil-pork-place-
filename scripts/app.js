...
const DATA = Object.freeze({
  ...
  menu: [
    { id: "m1",  name: "1/4 Pork + Ugali + Greens",      portion: "Standard",         priceKsh: 250,  category: "Pork Meals",   desc: "Wet Fry or Dry Fry.",                                              image: "images/pork-ugali-greens-clean.webp" },
    { id: "m6",  name: "1/4 Fry Pork (No Ugali)",         portion: "Meat Only",         priceKsh: 230,  category: "Pork Meals",   desc: "1/4 Fry Pork without Ugali.",                                      image: "images/fatty-dry-fry.webp" },
    { id: "cm1", name: "Combo: 1/4 Pork + Soda",          portion: "Meal + 300ml Soda", priceKsh: 300,  category: "Deals",        desc: "1/4 Pork + Ugali + Greens + Soda.",                                image: "images/pork-soda-combo.webp" },
    { id: "m2",  name: "1/2 kg Pork + Ugali + Greens",    portion: "Large",             priceKsh: 500,  category: "Pork Meals",   desc: "Great for hungry appetite.",                                       image: "images/image-13.webp" },
    { id: "m5",  name: "3/4 kg Pork + Ugali + Greens",    portion: "Extra Large",       priceKsh: 750,  category: "Pork Meals",   desc: "Perfect for sharing or large appetite.",                           image: "images/pork.webp" },
    { id: "m3",  name: "1 kg Pork + Ugali + Greens",      portion: "Platter",           priceKsh: 1000, category: "Pork Meals",   desc: "Sharing platter (Wet/Dry).",                                       image: "images/image-03.webp" },
    { id: "m4",  name: "Fatty Pork (Dry Fry)",             portion: "Standard",          priceKsh: 250,  category: "Pork Meals",   desc: "Rich, authentic dry-fried fatty pork. A Ruaka favorite.",          image: "images/fatty-dry-fry.webp" },
    { id: "m7",  name: "Authentic Smoked Pork",           portion: "Standard",          priceKsh: 300,  category: "Pork Meals",   desc: "Slow-smoked for hours. Deep, smoky flavor and tender texture.",    image: "images/pork-ribs-new.webp" },
    { id: "m8",  name: "Pork Stir Fry (Kochokocho)",      portion: "Standard",          priceKsh: 300,  category: "Pork Meals",   desc: "Spiced stir-fry with fresh peppers and onions — local 'Kochokocho' style.", image: "images/image-13.webp" },
    { id: "f1",  name: "Fries (Plate)",                    portion: "1 plate",           priceKsh: 130,  category: "Fries",        desc: "Crispy fries.",                                                    image: "images/fries-plate.webp" },
    { id: "f2",  name: "Fries + 1/4 Pork",                portion: "Mix",               priceKsh: 350,  category: "Fries",        desc: "Fries with authentic dry-fried or wet-fry pork.",                   image: "images/pork-fries-featured.webp" },
    { id: "f3",  name: "1kg Pork Mix Chipo Platter",       portion: "1kg Platter",       priceKsh: 1400, category: "Fries",        desc: "Massive pork & fries mix.",                                        image: "images/pork-mixed-chipo.webp" },
    { id: "c1",  name: "1/4 Kienyeji Chicken + Ugali",    portion: "Standard",          priceKsh: 400,  category: "Chicken Menu", desc: "Wet Fry Kienyeji chicken served with ugali and greens.",            image: "images/kienyeji-chicken-update.webp" },
    { id: "c2",  name: "1/4 Kienyeji Chicken (Dry Fry)",  portion: "1/4 Chicken",       priceKsh: 350,  category: "Chicken Menu", desc: "Tasty dry fried Kienyeji chicken. Ugali extra.",                   image: "images/kienyeji-dry-fry.webp" },
    { id: "c3",  name: "1/4 Kienyeji Chicken (Boiled)",   portion: "With Soup",         priceKsh: 350,  category: "Chicken Menu", desc: "Healthy boiled Kienyeji chicken with nourishing soup.",             image: "images/kienyeji-boiled.webp" },
    { id: "c4",  name: "1/4 Kienyeji Chicken (Stir Fry)", portion: "1/4 Chicken",       priceKsh: 400,  category: "Chicken Menu", desc: "Expertly stir fried Kienyeji chicken with fresh vegetables.",      image: "images/kienyeji-stir-fry.webp" },
    { id: "c5",  name: "1/4 Kienyeji Chicken (Wet Fry)",  portion: "1/4 Chicken",       priceKsh: 350,  category: "Chicken Menu", desc: "Rich and tasty Wet Fry Kienyeji chicken. Ugali extra.",             image: "images/wetfry.webp" },
    { id: "bf1", name: "Beef + Ugali + Greens",            portion: "Meal",              priceKsh: 350,  category: "Beef",         desc: "Tasty beef stew served with greens and ugali.",                    image: "images/image-11.webp" },
    { id: "bf2", name: "Beef + Fries",                     portion: "Mix",               priceKsh: 400,  category: "Beef",         desc: "Delicious beef stew served with our signature crispy fries.",      image: "images/beef-fries.webp" },
    { id: "d1",  name: "Soda (300ml)",                     portion: "300ml",             priceKsh: 50,   category: "Drinks",       desc: "Coke, Fanta, Sprite, etc.",                                        image: "images/coke-soda.webp" },
    { id: "d3",  name: "Dasani Water (500ml)",             portion: "500ml",             priceKsh: 50,   category: "Drinks",       desc: "Chilled bottled water.",                                           image: "images/dasani-water.webp" },
    { id: "s1",  name: "Extra Ugali",                      portion: "Side",              priceKsh: 40,   category: "Sides",        desc: "Hot extra ugali.",                                                 image: "images/extra-ugali.webp" },
    { id: "s2",  name: "Extra Vegetables",                 portion: "Side",              priceKsh: 40,   category: "Sides",        desc: "Fresh greens.",                                                    image: "images/greens.webp" },
  ],

  butchery: [
    { id: "b1", name: "Pork Ribs",             variant: "Unskinned",   pricePerKgKsh: 680,  desc: "Raw ribs (unskinned).",                  image: "images/pork-ribs-new.webp" },
    { id: "b2", name: "Pork Ribs",             variant: "Skinned",     pricePerKgKsh: 800,  desc: "Raw ribs (skin removed).",               image: "images/image-01.webp" },
    { id: "b3", name: "Pork Steak (Fat Free)", variant: "Prime Cut",   pricePerKgKsh: 920,  desc: "Tender steak cuts.",                     image: "images/pork-steak-new.webp" },
    { id: "b4", name: "Pork Belly",            variant: "Whole",       pricePerKgKsh: 680,  desc: "Perfect for roasting.",                  image: "images/pork-belly-update.webp" },
    { id: "b5", name: "Pork Shoulder",         variant: "Whole/Cut",   pricePerKgKsh: 680,  desc: "Fresh shoulder cut.",                    image: "images/pork-leg.webp" },
    { id: "b7", name: "Pork Chops",            variant: "Select Cut",  pricePerKgKsh: 920,  desc: "Premium pork chops cut fresh daily.",    image: "images/pork-chops.webp" },
    { id: "b8", name: "Pork Fillet",           variant: "Lean Cut",    pricePerKgKsh: 920,  desc: "Extra tender and lean pork fillet.",     image: "images/pork-fillet.webp" },
    { id: "b6", name: "Raw Kienyeji Chicken",  variant: "1 kg",        pricePerKgKsh: 1300, desc: "Fresh raw kienyeji chicken.",            image: "images/raw-kienyeji-chicken.webp" },
  ],
